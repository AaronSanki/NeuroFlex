export const USER_PROGRAMS = [
  {
    ...
    workout_plan: {
      ...
      description:
        "The description card is a static placeholder designed for demonstration purposes. The interactive functionality is currently out of scope for this version and will be implemented in a future sprint.",
    },
    diet_plan: {
